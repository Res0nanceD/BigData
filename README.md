...
Запустите команда создаст туннель, который пробрасывает 50070 с team-76-nn на team-76-jn, но снаружи он пока недоступен.
```bash
ssh -L 50070:team-76-nn:50070 -N -f hadoopuser@team-76-nn
```
